...
const translations = {
  ar: {
    ...
    review_form_booking_required: "يمكن فقط للعملاء الذين حجزوا موعدًا هنا إضافة تقييم.",
    ...
    provider_form_phone_placeholder: "مثال: 71 234567",
    ...
    admin_phone: "رقم واتساب",
    admin_phone_placeholder: "مثال: 71234567",
    ...
    generic_error: "حدث خطأ، الرجاء إعادة تحميل الصفحة والمحاولة مرة أخرى.",
    generic_session_error: "انتهت الجلسة، الرجاء إعادة تحميل الصفحة والمحاولة مرة أخرى.",
    admin_location_selected: "الموقع المختار:",
    admin_coords_label: "الإحداثيات",
    admin_coords_hint: "يمكنك لصق إحداثيات هنا لنقل الدبوس تلقائيًا، أو الضغط على الخريطة لتحديث الإحداثيات هنا",
    ...
    admin_appointments_button: "المواعيد",
    admin_appointments_loading: "جارٍ تحميل المواعيد...",
    admin_test_push_button: "إرسال إشعار تجريبي",
    admin_test_push_customer_name: "زبون تجريبي (اختبار)",
    admin_test_push_sent: "تم إرسال الإشعار التجريبي بنجاح.",
    admin_test_push_no_token: "لا يوجد إشعارات مفعّلة عند هذا المستخدم بعد.",
    admin_test_push_error: "فشل إرسال الإشعار التجريبي.",
    admin_qr_button: "رمز QR",
    admin_qr_download: "تحميل رمز QR",
    admin_qr_print: "طباعة",
  ...
  en: {
    ...
    review_form_booking_required: "Only customers who booked an appointment here can leave a review.",
    ...
    provider_form_phone_placeholder: "e.g. 71 234567",
    ...
    admin_phone: "WhatsApp number",
    admin_phone_placeholder: "e.g. 71234567",
    ...
    generic_error: "Something went wrong, please reload the page and try again.",
    generic_session_error: "Your session expired, please reload the page and try again.",
    admin_location_selected: "Selected location:",
    admin_coords_label: "Coordinates",
    admin_coords_hint: "Paste coordinates here to move the pin automatically, or click the map to update the coordinates here",
    ...
    admin_appointments_button: "Appointments",
    admin_appointments_loading: "Loading appointments...",
    admin_test_push_button: "Send test notification",
    admin_test_push_customer_name: "Test customer (test)",
    admin_test_push_sent: "Test notification sent successfully.",
    admin_test_push_no_token: "This provider hasn't enabled notifications yet.",
    admin_test_push_error: "Failed to send the test notification.",
